...
import com.tiendaS.domain.Ruta;
import com.tiendaS.service.RutaPermitService;
import com.tiendaS.service.RutaService;
...
//                .build();
//
//        return new InMemoryUserDetailsManager(user, sales, admin, superAdmin);
//    }
    @Autowired
