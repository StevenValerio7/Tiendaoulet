...
import com.tiendaS.service.ConstanteService;
...
public class ConstanteController {
    ...
    public String eliminar(Constante constante,
        ...
        if (constante == null) {
            redirectAttrs.addFlashAttribute("error", messageSource.getMessage("constante.error01", null, Locale.getDefault()));
        } else if (false) {
            redirectAttrs.addFlashAttribute("error", messageSource.getMessage("constante.error02", null, Locale.getDefault()));
            ...
            redirectAttrs.addFlashAttribute("error", messageSource.getMessage("constante.error03", null, Locale.getDefault()));
        }
        return "redirect:/constante/listado";

        /* va en lugar del false... constante.getProductos() != null && !constante.getProductos().isEmpty()*/
    }
